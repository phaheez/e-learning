								...
								<table cellpadding="0" class="table table-striped" style="font-family:tahoma;background-color:rgba(230, 230, 230, 0.65);">
									...
									<tbody>
										<tr>
											...
											<td>
												<a title="View Message" href="#viewmessage" role="button" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open"></span>&nbsp;View</a>
											</td>
										</tr>
										<tr>
											<td>Student</td>
										...
										<?php include('viewmessage_modal.php'); ?>
									</tbody>
								</table>
							</div>
						</div>
								...
								<table cellpadding="0" class="table table-striped" style="font-family:tahoma;background-color:rgba(230, 230, 230, 0.65);">
									...
									<tbody>
										<tr>
											...
											<td>Monday, August 15, 2016</td>
											<td>
												<a title="View Message" href="#inbox" role="button" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open"></span>&nbsp;View</a>
											</td>
										</tr>
										<tr>
											<td>Phaheez</td>
