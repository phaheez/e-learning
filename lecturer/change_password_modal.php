<!-- Modal -->
<div id="change-password<?php echo $lecturer_id; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" 
    aria-hidden="true">
                        ...
                        <div class="modal-footer">
                            ...
                            if (isset($_POST['btnChange'])) {
                                ...
                                if ($new !== $confirm) {
                                    ...
                                    mysql_query("UPDATE lecturer SET password='$new' WHERE lecturer_id='$lecturerID'") or die(mysql_error());
                                    ?>
                                    <script>
